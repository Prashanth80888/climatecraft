        ...
        <div className="lg:col-span-6">
          ...
          <Reveal delay={0.15}>
            <div ref={ref} className="mt-12 max-w-md">
              ...
              <div className="relative mt-4 h-2 overflow-hidden rounded-full bg-white/50">
                <motion.div
                  initial={{ scaleX: 0 }}
                ...
                <motion.div
                  ...
                  transition={{ duration: 1.6, ease: easeOut }}
                  className="absolute top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-white bg-white shadow-[0_0_0_4px_rgba(22,155,154,0.25)]"
                />
              </div>
