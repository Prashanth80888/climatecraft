            ...
            {FAMILY_ORDER.map((id) => {
              ...
              return (
                <button
                  ...
                  className={`relative rounded-full px-5 py-2.5 text-[11px] font-semibold uppercase tracking-[0.14em] transition-colors duration-300 sm:px-6 ${
                    selected
                      ? 'text-white'
            ...
            >
              <div className="lg:col-span-8">
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] w-full rounded-[30px] sm:aspect-[16/10]">
                    <motion.img
                      key={product.slug}
                      src={displayImage}
                      alt={product.name}
                    ...
                    <div className="absolute left-5 top-5 z-40">
                      <div className="rounded-full border border-white/75 bg-white/80 px-4 py-2 shadow-[0_12px_28px_-16px_rgba(6,59,61,0.4)] backdrop-blur-xl">
                        <span className="text-[9px] font-semibold uppercase tracking-[0.16em] text-gold-700">
                          {product.name}
                        </span>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <motion.span
                              ...
                              className={`relative flex h-9 w-9 items-center justify-center rounded-full border font-display text-[11px] italic shadow-[0_8px_24px_-8px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-all duration-300 sm:h-10 sm:w-10 ${
                                isActive
                            ...
                            <AnimatePresence>
                              {isActive && (
                                <motion.div
                                  ...
                                  className={`pointer-events-auto absolute w-[205px] sm:w-[235px] ${tooltipClasses(
                                    feature.placement,
                                  )}`}
                                  onMouseEnter={() =>
                                    activateFeature(
                    ...
                    <div className="absolute bottom-5 left-5 z-40">
                      <div className="flex items-center gap-2 rounded-full border border-white/35 bg-black/20 px-3.5 py-2 backdrop-blur-xl">
                ...
                <p className="mt-3 text-center text-[10px] font-medium uppercase tracking-[0.16em] text-cream-200 lg:hidden">
                  Tap a numbered point to explore
                </p>
              </div>
