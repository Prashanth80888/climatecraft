                      ...
                      >
                        {images.map((src, i) => (
                          <button
                            ...
                            className={`h-1.5 rounded-full transition-all duration-400 ${i === index
                                ? 'w-6 bg-gold-400'
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4">
                {TRAITS.map((trait, i) => (
                  <button
                    ...
                    className={`rounded-2xl border px-5 py-4 text-left transition-all duration-300 ${i === index
                        ? 'border-gold-400/50 bg-gold-400/[0.06]'
                        : 'border-[#063B3D]/20 bg-white/50 hover:border-[#063B3D]/35'
                      }`}
                  >
                    <span className="font-display text-lg italic text-cream-100">
                      {trait}
                    </span>
                  </button>
                ))}
