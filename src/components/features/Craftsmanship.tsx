...
const POINTS = [
  {
    ...
    copy: 'Every panel is finished in premium fabric, chosen for how it wears as much as how it looks.',
  },
  {
    title: 'Generous Cushioning',
    copy: 'Deep, considered cushioning across the seat and back, built to hold its shape.',
  },
  {
    title: 'Ergonomic Design',
    copy: 'Every seating surface is shaped around the body, not the other way around.',
  },
  {
    title: 'Contemporary Silhouette',
    copy: 'A clean, restrained profile that sits comfortably in any interior.',
  },
]
            ...
            <RevealGroup className="mt-10 divide-y divide-[#063B3D]/10 border-t border-[#063B3D]/20">
              {POINTS.map((p) => (
                <RevealItem key={p.title} className="py-5">
                  ...
                  <p className="mt-1.5 max-w-md text-[14px] leading-relaxed text-cream-200">
                    {p.copy}
                  </p>
                </RevealItem>
              ))}
