        ...
        <RevealGroup className="mt-14 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:mt-20">
          {SPACE_PROCESS.map((step) => (
            <RevealItem key={step.number}>
              <div className="group relative flex flex-col gap-4 rounded-[20px] border border-ink-900/[0.08] bg-white/35 p-6 transition-all duration-500 hover:border-gold-400/20 hover:bg-white/55">
