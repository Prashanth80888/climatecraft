      ...
      <div className="relative mx-auto max-w-4xl px-5 py-20 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        ...
        <Reveal delay={0.16}>
          <p className="mx-auto mt-5 max-w-xl text-[15px] leading-7 text-white/85 sm:text-base">
            Tell us about your room, seating requirements and preferred level of control. We&apos;ll help shape the right
            Climate Craft configuration.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.24}>
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              href={whatsappHref(
                "Hi Climate Craft, I'd like to talk about a project I saw on your site."
              )}
              target="_blank"
              rel="noreferrer"
